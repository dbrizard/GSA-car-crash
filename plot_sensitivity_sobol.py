...
SAJ = ot.JansenSensitivityAlgorithm(inputDesign, outputDesign, size)
graphJ = SAJ.draw()
viewj = viewer.View(graphJ)

SAM = ot.MauntzKucherenkoSensitivityAlgorithm(inputDesign, outputDesign, size)
graphM = SAM.draw()
viewm = viewer.View(graphM)
